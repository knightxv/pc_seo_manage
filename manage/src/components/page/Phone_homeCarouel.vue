    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>手机首页轮播</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="hot-title">手机首页轮播</div>
        <el-button
            type="primary"
            @click="showHandleAdd"
        >
...
<script>
    export default {
        ...
        async created() {
            // 首页轮播
            const res = await this.webHttp.get('/api/phone/homeCarousel');
            if (res.success) {
        ...
        methods: {
            ...
            async handleEdit() {
                ...
                const res = await this.webHttp.get('/api/manage/phone/editCarousel', {
            ...
            async handleAddCarousel() {
                ...
                const createRes = await this.webHttp.get('/api/manage/phone/createCarousel', {
            ...
            async handleDelete(index, row) {
                const { id } = row;
                 const res = await this.webHttp.get('/api/manage/phone/deleteCarousel', {
                    id,
                });
                if (res.success) {
